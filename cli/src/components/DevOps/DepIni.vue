      ...
      <table class="table is-striped is-fullwidth has-text-centered">
        ...
        <tbody class>
          <tr v-for="(k,i) in depIniList" :key="i">
              ...
              <div class="dropdown is-hoverable">
                ...
                <div class="dropdown-menu" id="dropdown-menu" role="menu">
                  <div class="dropdown-content">
                    <tr v-for="t in serverType" :key="t">
                      <a
                        class="dropdown-item"
            ...
            <td>
              <button class="button is-primary is-small is-vcentered" @click="uploadChange(i)">修改</button>
              <button class="button is-danger is-small" @click="deleteIni(i)">删除</button>
            </td>
          </tr>
        </tbody>
      </table>
