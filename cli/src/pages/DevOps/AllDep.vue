            ...
            <tbody>
                <tr v-for="(info,i) in progressList" :key="i">
                    <td @click="showProgressDetails(info[1])">
                                ...
                                <div class="field is-grouped is-grouped-multiline">
                                    ...
                                    <div class="control">
                                        <div class="tags has-addons">
                                            ...
                                            <span class="tag is-light">{{new Date(parseInt(info[0])*1000).toLocaleString()}}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control">
                                        <div class="tags has-addons">
                                            ...
                                            <span class="tag" :class="{'is-success':info[3]==progressDesc.length-1,
                        'is-warning':info[3]!=progressDesc.length-1&& info[3]>=0,
                        'is-danger':info[3]<0}">{{progressDesc[info[3]]}}</span>
                                        </div>
                                    </div>
                        ...
                        <div class="columns">
                            <div class="column">
                                <progress class="progress" :class="{'is-danger':info[3]<0,
                    'is-success':info[3]==progressDesc.length-1}" :value="info[3]>=0?(info[3]/(progressDesc.length-1)):1" max="1"></progress>
                            </div>
                        </div>
                    </td>
                </tr>
    ...
    <div id="details" class="modal is-large" :class="{'is-active':modalActive}">
        ...
        <div class="modal-card">
            <header class="modal-card-head">
                <p class="modal-card-title">{{typeof currFoucsIdx==='number'?allDeps[currFoucsIdx][1].title:"非法上线单"}}</p>
            ...
            <section class="modal-card-body">
                <div class="content">
                    ...
                    <h4>版本描述</h4>
                    <tr v-for="(msg,i) in typeof currFoucsIdx==='number'?allDeps[currFoucsIdx][1].desc.slice(1,-2):[]" :key="i">
                        <p>{{msg}}</p>
                    </tr>
                </div>
            </section>
